 ...
 */
class CRM_Smshub_Upgrader_Base {

  /**
   * @var CRM_Smshub_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Smshub_Upgrader(
        'smshub',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Smshub_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Smshub_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
